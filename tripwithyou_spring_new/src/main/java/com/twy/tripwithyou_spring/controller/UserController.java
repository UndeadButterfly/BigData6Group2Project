...
public class UserController {
    ...
    public void myUpload(HttpServletRequest req, @SessionAttribute UserDto loginInfo, Model model, PagingDto paging) {
    ...
    public void myCourse(HttpServletRequest req, @SessionAttribute UserDto loginInfo, Model model, PagingDto paging) {
        String userId = loginInfo.getUserId();
    ...
    public void myMatching(HttpServletRequest req, @SessionAttribute UserDto loginInfo, Model model, PagingDto paging) {
        String userId = loginInfo.getUserId();
        paging = new PagingDto(1, 10, "matching_no", "desc");
